...
import { Mail, Check, Copy, FileText, ArrowUpRight, MessageSquare } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 hover:border-zinc-700 transition-all flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-base font-bold text-white mb-1">Resume & Profiles</h3>
              <p className="text-xs text-zinc-400 mb-4">Review complete work history and GitHub repos</p>
            </div>
            <div className="flex flex-col gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-white text-zinc-950 hover:bg-zinc-200 text-xs font-semibold transition-colors"
              >
              ...
              <div className="grid grid-cols-2 gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 py-2 px-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-xs font-medium text-zinc-300 transition-colors border border-zinc-700/60"
                >
